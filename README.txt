...
Este é um sistema de gerenciamento de RPG desenvolvido em Java 24 com Spring Boot 3.4.4.

Funcionalidades
--------------
- Gerenciamento de personagens (CRUD completo)
- Gerenciamento de itens mágicos (CRUD completo)
...
-------------------
- src/main/java/com/rpg_eduardo/demo/
